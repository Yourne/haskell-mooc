...
countdown x = "Ready! " ++ countBackwards x ++ "Liftoff!"

countBackwards :: Integer -> String
countBackwards 0 = ""
countBackwards x = show x ++ "... " ++ countBackwards(x-1)
...
-- smallestDivisor' x y 
    -- | mod x y == 0 = y
    -- | y >= x = x
    -- | otherwise = smallestDivisor' x (y+2) # it skips all odd numbers
